...
<body>
    ...
    <div class="jumbotron">
        ...
        -webkit-background-clip: text;background-clip: text;color: transparent;">METER DATOS</h1>
    </div>
<div class="contenedor">
    <div class="container1">
        ...
        <input type="text" id="Apellido" name="Apellido" requiered><br></div>

        <div class="form-group"><label for="Apodo">Apodo: </label>
        <input type="text" id="Apodo" name="Apodo" requiered><br></div>
        ...
        <input type="text" id="Rango" name="Rango" requiered><br></div>

        <div class="form-group"><label for="Universidad">Universidad: </label>
        <input type="text" id="Universidad" name="Universidad" requiered><br></div>
